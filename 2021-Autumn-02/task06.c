...
//На вход программе подается натуральное число N не превосходящее 10000 и, далее, N чисел задающих перестановку π длины N. 
...
int main(void)
{
	...
	for (int i = 1; i <= n; i++)
		pi_pi_pi.mas[i] = pi.mas[pi.mas[pi.mas[i]]];

	vector_print(&pi_pi_pi, 1, pi_pi_pi.used - 1);
